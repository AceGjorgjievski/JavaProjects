...
*/
        ...
        table2.insert(new ChemicalElement("Be"), 56);
        ...
        table2.insert(new ChemicalElement("Cb"), 57);
        table2.insert(new ChemicalElement("Cb"), 58);
        table2.insert(new ChemicalElement("Ca"), 21);
        table2.insert(new ChemicalElement("Bz"), 56);
        table2.insert(new ChemicalElement("Bz"), 66);

        System.out.println ("Tabelata od slajd 7");
        System.out.println(table2);


        table2.insert(new ChemicalElement("Pu"),11);
        table2.insert(new ChemicalElement("Ba"),11);

        table2.delete(new ChemicalElement("Bz"));
//        System.out.println(table2.search(new ChemicalElement("Pu")));
        System.out.println(table2.search(new ChemicalElement("Pu")));
        System.out.println(table2);
    }
}        