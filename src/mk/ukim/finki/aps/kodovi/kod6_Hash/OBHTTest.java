...
public class OBHTTest {
    ...
    public static void main (String[] args) {
        ...
        table1.insert(new ChemicalElement("E"), 56);
        table1.insert(new ChemicalElement("F"), 56);
        table1.insert(new ChemicalElement("G"), 56);
        table1.insert(new ChemicalElement("Be"), 2);

        System.out.println ("Initial table.");
        System.out.println(table1);
        System.out.println("===========");
        System.out.println(table1.search(new ChemicalElement("Be")));
        
        OBHT<ChemicalElement,Integer> table2 = (OBHT<ChemicalElement,Integer>) table1.clone();
        
        table1.insert(new ChemicalElement("Fr"), 7);
        table1.insert(new ChemicalElement("Ra"), 8);
        table1.insert(new ChemicalElement("B"),  5);
        table1.delete(new ChemicalElement("Ca"));
        table1.insert(new ChemicalElement("Be"),20);
        ...
        System.out.println("Table after deleting Be, B");
        System.out.println(table2);
        
        table2.insert(new ChemicalElement("Ba"), 56);
        table2.insert(new ChemicalElement("Be"), 4);

        System.out.println("Table after adding Ba, Be");
        System.out.println(table2);
        
        table2.delete(new ChemicalElement("Ba"));
        table2.delete(new ChemicalElement("Ba"));
        table2.delete(new ChemicalElement("Ba"));
        System.out.println("Table after deleting Ba");
        System.out.println(table2.search((new ChemicalElement("Be"))));
        System.out.println(table2);
