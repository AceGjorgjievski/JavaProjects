...
//            throw new NoSuchElementException();
    ...
    public String pecatiNizata(){
        ...
        stringBuilder.append("Elementite se: ");
    	for(E elem : elems)
    ...
    public static void main (String[] args) {
        ...
        System.out.println(d.pecatiNizata());

        System.out.println(d.popFirst());
        System.out.println(d.popSecond());
        System.out.println(d.pecatiNizata());
       /* System.out.println(d.pecatiNizata());
        ...
        System.out.println(d.peekSecond());
...
*/
        ...
        System.out.println();
        System.out.println("Dodavanje na prv: ");
    	//d.pushFirst(4);
    	d.pushSecond(4);
        System.out.println(d.pecatiNizata());
    	d.popFirst();
