package mk.ukim.finki.aps.labs.kolokviumski1.PalindromeSLL;
...
public class PalindromeSLL {
    ...
    private static int isItPalindrome(SLL<Integer> original){

        SLL<Integer> mirroredList = new SLL<>();
        SLLNode<Integer> tmpOriginal = original.getFirst();
        ...
        mirroredList.mirror();
        System.out.println(tmpOriginal);
        System.out.println(mirroredList);
        SLLNode<Integer> tmpMirror = mirroredList.getFirst();

        while (tmpMirror != null && tmpOriginal != null){
            if(!tmpMirror.element.equals(tmpOriginal.element)) return -1;
            tmpMirror = tmpMirror.succ;
            tmpOriginal = tmpOriginal.succ;
        }
        return 1;
    }
