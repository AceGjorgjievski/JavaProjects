package mk.ukim.finki.aps.labs.kolokviumski1.ListaOdListi;
...
public class ListaOdListi {
    ...
    public static long findMagicNumber(DLL<DLL<Integer>> listOfLists) {
        long produt = 1;

        DLLNode<DLL<Integer>> outside = listOfLists.getFirst();
