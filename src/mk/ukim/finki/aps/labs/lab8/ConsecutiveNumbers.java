package mk.ukim.finki.aps.labs.lab8;
...
public class ConsecutiveNumbers {
    ...
    public static void main(String[] args) {
        ...
        BNode<Integer> root = null,a=null,b=null,c=null;
        int numberOfNode,valueOfNode;
        String leftRight;
        int leftRightFromWhom;
        int flag = 1,flag2=1,flag3=1,flag4=1;

        for(int i=0; i<n; i++){
            numberOfNode = scanner.nextInt();
            valueOfNode = scanner.nextInt();

            if(flag == 1){
                leftRight = scanner.nextLine();
                root = tree.makeRoot(valueOfNode);
                flag = 0;
            } else if(flag2==1){
                leftRight = scanner.nextLine();
                leftRightFromWhom = scanner.nextInt();
                a = tree.addChild(valueOfNode,stringToInt(leftRight),root);
                flag2 = 0;
            } else if(flag3 == 1){
                leftRight = scanner.nextLine();
                leftRightFromWhom = scanner.nextInt();
                b = tree.addChild(valueOfNode,stringToInt(leftRight),a);
                flag3 = 0;
            } else if(flag4 == 1){
                leftRight = scanner.nextLine();
                leftRightFromWhom = scanner.nextInt();
                c = tree.addChild(valueOfNode,stringToInt(leftRight),b);
                flag4 = 0;
            }
        }
    }
