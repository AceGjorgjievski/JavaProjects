package mk.ukim.finki.aps.vezhbi.JoinSortedLists;
...
public class JoinSortedLists {

    private static void joinSorted(SLL<Integer> list1, SLL<Integer> list2) {
        SLLNode<Integer> prv = list1.getFirst();
        SLLNode<Integer> vtor = list2.getFirst();

        SLL<Integer> krajna = new SLL<Integer>();
        ...
        while(prv != null && vtor != null) {
            ...
            if(prv.element < vtor.element) {
                krajna.insertLast(prv.element);
                prv = prv.succ;
            } else {
                krajna.insertLast(vtor.element);
                vtor = vtor.succ;
            }
        }
