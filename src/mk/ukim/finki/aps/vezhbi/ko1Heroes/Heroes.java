package mk.ukim.finki.aps.vezhbi.ko1Heroes;
...
public class Heroes {
    ...
    private static void startHeroesGame(SLL<Card> firstFriendCards, SLL<Card> secondFriendCards) {
        SLLNode<Card> p1 = firstFriendCards.getFirst();
        SLLNode<Card> p2 = secondFriendCards.getFirst();

        SLLNode<Card> maxCard = p1;
        p1 = p1.succ;

        while(p1 != null) {
            if(maxCard.element.damage() < p1.element.damage()) {
                maxCard = p1;
            }
            p1 = p1.succ;
        }
        ...
        Card after = null;
        SLLNode<Card> afterNode = maxCard;
        for(int i=0; i<2; i++) {
            p2 = p2.succ;
        }

        secondFriendCards.insertAfter(afterNode.element,p2);
