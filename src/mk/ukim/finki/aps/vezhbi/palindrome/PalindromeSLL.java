package mk.ukim.finki.aps.vezhbi.palindrome;
...
public class PalindromeSLL {
    ...
    public static boolean isPalindrome(SLL<Integer> lista) {
        SLLNode<Integer> node1 = lista.getFirst();
        lista.mirror();
        SLLNode<Integer> node2 = lista.getFirst();
    ...
    public static void main(String[] args) {
        ...
        System.out.println(isPalindrome(lista));
