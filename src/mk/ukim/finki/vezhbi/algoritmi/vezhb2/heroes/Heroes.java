package mk.ukim.finki.vezhbi.algoritmi.vezhb2.heroes;
...
public class Heroes {
    ...
    public static void startHeroesGame(SLL<Card> firstFriendCards, SLL<Card> secondFriendCards) {
        SLLNode<Card> prva = firstFriendCards.getFirst();
        SLLNode<Card> vtor = secondFriendCards.getFirst();

        Card card = null;
        int maxDamage = Integer.MIN_VALUE;
        SLLNode<Card> toBeDeleted = null;
        while (prva != null) {

            if(prva.element.damage() > maxDamage) {
                maxDamage = prva.element.damage();
                card = prva.element;
                toBeDeleted = prva;
            }
            prva = prva.succ;
...
//        System.out.println(card);
        ...
        firstFriendCards.delete(toBeDeleted);

        for(int i=0; i<secondFriendCards.length()/2-1; i++){
            vtor = vtor.succ;
        }

        secondFriendCards.insertAfter(card,vtor);
