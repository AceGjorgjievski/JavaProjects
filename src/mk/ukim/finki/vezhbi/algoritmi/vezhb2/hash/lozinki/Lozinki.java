package mk.ukim.finki.vezhbi.algoritmi.vezhb2.hash.lozinki;
...
KRAJ
    ...
    public static void main(String[] args) throws IOException {
        ...
        CBHT<String,String> map = new CBHT<>(26);
        ...
        while (true) {
            ...
            SLLNode<MapEntry<String, String>> local = map.search(parts[0]);

            if(local != null && local.element.value.equals(parts[1])) {
