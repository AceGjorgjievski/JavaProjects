package mk.ukim.finki.os.auds.aud_5_SyncExamples.Band;
...
public class MusicBand {
    ...
    public static Semaphore siEnter;
    public static Semaphore gpEnter;

    public static Semaphore siHere;
    public static Semaphore ready;
    public static Semaphore playingDone;
    ...
    public static void init() {
        siEnter = new Semaphore(2);
        gpEnter = new Semaphore(3);

        siHere = new Semaphore(0);
        ready = new Semaphore(0);
        playingDone = new Semaphore(0);
